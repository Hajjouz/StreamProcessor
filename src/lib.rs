// src/lib.rs
/*
 * Core library for StreamProcessor
 */
...
#[derive(Debug)]
pub struct StreamProcessorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StreamProcessorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StreamProcessor processing");
    
    let mut processor = StreamProcessorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StreamProcessorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StreamProcessorProcessor::new(false);
